...
5. From now on, you will run all the flutter commands with the `fvm` prefix. Get all the projects
   dependencies.
...
The coding challenge is a take-home test upon which we'll be conducting a thorough code review once
